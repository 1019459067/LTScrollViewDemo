...
public class LTAdvancedManager: UIView {
    ...
    private var titles: [LTButtonModel]
    private weak var currentViewController: UIViewController?
    private var pageView: LTPageView!
    private var layout: LTLayout
    
    @objc public init(frame: CGRect, viewControllers: [UIViewController], titles: [LTButtonModel], currentViewController:UIViewController, layout: LTLayout, headerViewHandle handle: () -> UIView) {
